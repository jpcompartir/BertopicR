...
install_python_dependencies <- function(){
  ...
  bertopic_0_15_0_deps <- c("bertopic==0.15.0", "numpy>=1.20.0", "hdbscan>=0.8.29", "umap-learn>=0.5.0", "pandas>=1.1.5", "scikit-learn>=0.22.2.post1", "tqdm>=4.41.1", "sentence-transformers>=0.4.1","plotly>=4.7.0", "openai>=0.27.8")
