...
topic_representations %>% DT::datatable(options = list(scrollX = TRUE))
```
...
If you will be using your model in the future, you can also update your model with those new topics.
