...
:   
    ...
    Fine-tuning topic representations - other tools for topic representations (includes generative AI/LLMs), you can read more about this in the [Manipulating the Model](manipulating-the-model.Rmd) vignette.
...
Now that you have your model up and running, you could look at the [Manipulating the Model](manipulating-the-model.Rmd) vignette to see how you could investigate and alter the topics that have been identified.
