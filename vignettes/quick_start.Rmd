...
as the function changes the input model in place. See the Note under the Fit the Model section in the 
[Interacting with Individual Modules](modular_approach.html) vignette for more detail.
