...
The goal of BertopicR is to allow R users to access bertopic's topic modelling suite in R.

The package currently installs an exact version of bertopic - 0.14.0, this should make it easier to maintain the package over time and prevent new users from running into install errors.
...
A typical workflow can be found at: https://aoiferyan-sc.github.io/BertopicR/articles/bertopic.html
