...
The goal of BertopicR is to allow R users to access bertopic's topic modelling suite in R. The package does not aim to implement every feature of bertopic, you may  submit issues for feature requests; however,it may be faster to go direct to the original, Python library which has excellent documentation.
